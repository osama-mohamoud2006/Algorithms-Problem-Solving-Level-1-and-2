...
project_dir="E:\projects\c++ course\Algorithms & Problem-Solving Level 2\Project2"
cd "$project_dir" || exit
...
# Git إعداد الريموت لو مش موجود
git remote set-url origin "https://github.com/osama-mohamoud2006/Math-Quiz"
